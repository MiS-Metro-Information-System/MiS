...
import iomis.github.mis_metro_information_system.mis.utils.PollingCheck;
...
public class TestUtils extends AndroidTestCase {
    ...
    static void testValuesCursor(String error, Cursor valueCursor, ContentValues expectedValues) {
